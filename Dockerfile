...
# - pkg-config, libdbus-1-dev, libglib2.0-dev, dbus, cmake, ninja-build: 构建 dbus-python 等原生扩展所需
RUN apt-get update && apt-get install -y --no-install-recommends \
    gcc g++ libpq-dev pkg-config libdbus-1-dev libglib2.0-dev dbus cmake ninja-build \
